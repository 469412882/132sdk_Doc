...
.method public onCreate()V
    ...
    sget-object v1, Lcn/jpush/android/service/PushService;->mBinder:Lcn/jiguang/b/b;

    if-nez v1, :cond_1

    new-instance v1, Lcn/jiguang/g/a/a;

    invoke-direct {v1}, Lcn/jiguang/g/a/a;-><init>()V

    sput-object v1, Lcn/jpush/android/service/PushService;->mBinder:Lcn/jiguang/b/b;
    ...
    invoke-static {v1}, Lcn/jiguang/g/a;->l(Landroid/content/Context;)V

    invoke-static {}, Lcn/jiguang/d/b/d;->a()Lcn/jiguang/d/b/d;

    move-result-object v1

    invoke-virtual {v1, p0}, Lcn/jiguang/d/b/d;->a(Landroid/content/Context;)V
    ...
    invoke-virtual {v1, v2, v3}, Lcn/jiguang/d/h/f;->a(Landroid/content/Context;Z)V
    :try_end_0
    ...
    invoke-virtual {p0, v2, v1}, Lcn/jpush/android/service/PushService;->registerReceiver(Landroid/content/BroadcastReceiver;Landroid/content/IntentFilter;)Landroid/content/Intent;
    :try_end_1
    ...
    invoke-virtual {v0, v1}, Lcn/jiguang/g/n;->a(Ljava/lang/String;)V
...
.method public onStartCommand(Landroid/content/Intent;II)I
    ...
    const-string p2, "onStartCommand:JCoreInterface init failed"
    ...
    invoke-virtual {p1, p0, v0, p2}, Lcn/jiguang/d/d/j;->a(Landroid/content/Context;Ljava/lang/String;Landroid/os/Bundle;)V
    :try_end_2
    ...
    const-string v1, "PushService onStartCommand error:"
